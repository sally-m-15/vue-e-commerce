<template>
    ...
    >
        ...
        >
            ...
            <div class="aspect-[2160/2000]">
                <img class="h-full w-full object-cover aspect-[2160/2000]" loading="lazy" width="2160" decoding="async"
              height="2000" :src="products.imageCover" :alt="products.title">
            </div>
