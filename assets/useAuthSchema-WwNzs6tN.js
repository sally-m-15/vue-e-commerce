import{c as r,a as e,b as i}from"./yup-Cd09XHOC.js";import{h as o}from"./index-CJhB2E29.js";import{c as n,r as c}from"./@vue-BbMJBAuL.js";const d=c(!1),l=r({name:e().required("name is required").min(3),email:e().required("email is required").matches(/^[^\s@]+@[^\s@]+\.[^\s@]+$/),password:e().required("password is required").matches(/^[A-Za-z][A-Za-z0-9]{5,8}$/,`must be
