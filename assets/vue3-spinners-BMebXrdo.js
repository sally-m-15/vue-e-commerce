...
`;ze(Ae,{});h({size:15,margin:"2px"});var J=[],N=[];function Me(t,e){if(t&&typeof document<"u"){var a,i=e.prepend===!0?"prepend":"append",c=e.singleTag===!0,s=typeof e.container=="string"?document.querySelector(e.container):document.getElementsByTagName("head")[0];if(c){var n=J.indexOf(s);n===-1&&(n=J.push(s)-1,N[n]={}),a=N[n]&&N[n][i]?N[n][i]:N[n][i]=u()}else a=u();t.charCodeAt(0)===65279&&(t=t.substring(1)),a.styleSheet?a.styleSheet.cssText+=t:a.appendChild(document.createTextNode(t))}function u(){var o=document.createElement("style");if(o.setAttribute("type","text/css"),e.attributes)for(var d=Object.keys(e.attributes),l=0;l<d.length;l++)o.setAttribute(d[l],e.attributes[d[l]]);var m=i==="prepend"?"afterbegin":"beforeend";return s.insertAdjacentElement(m,o),o}}var Ee=`
...
`;Re(Le,{});const qe={name:"VueSpinnerClimbingBox"};({...qe,props:h({size:15})});var te=[],z=[];function De(t,e){if(t&&typeof document<"u"){var a,i=e.prepend===!0?"prepend":"append",c=e.singleTag===!0,s=typeof e.container=="string"?document.querySelector(e.container):document.getElementsByTagName("head")[0];if(c){var n=te.indexOf(s);n===-1&&(n=te.push(s)-1,z[n]={}),a=z[n]&&z[n][i]?z[n][i]:z[n][i]=u()}else a=u();t.charCodeAt(0)===65279&&(t=t.substring(1)),a.styleSheet?a.styleSheet.cssText+=t:a.appendChild(document.createTextNode(t))}function u(){var o=document.createElement("style");if(o.setAttribute("type","text/css"),e.attributes)for(var d=Object.keys(e.attributes),l=0;l<d.length;l++)o.setAttribute(d[l],e.attributes[d[l]]);var m=i==="prepend"?"afterbegin":"beforeend";return s.insertAdjacentElement(m,o),o}}var Ve=`
